...
def export_steady_state_trace(  # noqa: PLR0912, PLR0915
    ...
    *,
    ...
    if compact:
        ...
        tid_of_transfer: dict[object, int] = {}
        ...
        for node in tta.transfer_nodes:
            ...
            input_of: list[str] = [
                n.name for n in tta.workload.successors(node) if isinstance(n, _ComputationNode)
            ]
            output_of: list[str] = [
                n.name for n in tta.workload.predecessors(node) if isinstance(n, _ComputationNode)
            ]
                ...
                trace_events.append(
                    {
                        ...
                        "args": {
                            ...
                            "input_of": input_of,
                            "output_of": output_of,
                            "full_path": _path_label(chosen_path.links_used),
                            "n_links": len(chosen_path.links_used),
                            "reuse": reuse_summary,
                        },
                    }
